...
if __name__ == "__main__":
    ...
    gaze_data_dict = generate_gaze_data("flaskr\\fixation\\test_data\\2023_06_01_18_47_34\\processedGaze\\gaze.npz")
    ...
    for sample_i in range(data.size-1):
        ...
        if end_time - start_time < 0.15:
            continue
        visualize_session(eye_video1_path, eye_video2_path, world_video_path, start_time, end_time, v_hat)