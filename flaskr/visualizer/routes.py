...
def visualizer():
    ...
    start_fixation_algorithm(odometry_file=odo_pldata_path, gaze_file=gaze_npz_path, world_video_file=world_path, csv_file=csv_path, eye0_file=eye0_path, eye1_file=eye1_path, export_json_path=EXPORT_JSON_PATH, export_parameters_path=EXPORT_PARAMETER_PATH, in_args=session["fixation_params"])
